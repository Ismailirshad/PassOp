...
function Manager() {
    ...
    const getPasswords = async () => {
        let req = await fetch("https://passop-kgh0.onrender.com/passwords");
        ...
        if (form.site.length > 3 && form.username.length > 3 && form.password.length > 3) {
            try {
                if (form._id) {
                    ...
                    await fetch("https://passop-kgh0.onrender.com/passwords", {
                        method: "DELETE",
                ...
                // Save new password
                const res = await fetch("https://passop-kgh0.onrender.com/passwords", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
